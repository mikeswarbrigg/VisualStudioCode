...
public class questionAnswers {
    ...
    public static void Q1() {
        while (true) {
            ...
            if (input.equals("square")) {
                // seperated each variable to into their blocks so you know whats happening where
                double a;
    ...
    public static void Q2() {
        ...
        // seperated if statements just easier to read
        if(num2 == 1) {
...
public static void Q3() {
    ...
    // indented if statements inside for loops , easier on the eyes
    for (int i = 0; i < n; i++) {
        if (i < 2)
            continue;
    boolean check = true;
